jQuery(function($){
    ...
    function validLoginName(){
        if($.trim(loginName.val())!="") return true;
        alert("请输入用户登录名");
        return false;
    }
    ...
    function validPassword(){
    	if($.trim(password.val())!="") return true;
        alert("请输入用户密码");
        return false;
    }
    function validEmail(){
    	if($.trim(email.val())!="") return true;
        alert("请输入用户邮箱");
        return false;
    }
    
    addForm.on('submit',function(){
        return validLoginName()&&validUserName()&&validPassword()&&validEmail();
    });
